...
def getuserratings(userid):
    sampleinteractions = interactions.loc[interactions['user_id'] == userid]
    sampleinteractions = sampleinteractions.groupby(by='item_id', group_keys=False).apply(lambda x: x.ix[x.interaction_type.idxmax()])
